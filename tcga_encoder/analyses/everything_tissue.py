...
if __name__ == "__main__":
  ...
  min_p_value=1
  threshold=0.0
  deeper_meaning_dna_and_data_correct_by_tissue( data, data.Z, "Z", nbr_dna_genes2process=nbr_dna_genes2process, K=K, min_p_value=min_p_value, threshold=threshold, Cs = Cs )
  deeper_meaning_dna_and_data_correct_by_tissue( data, data.RNA_fair, "RNA", nbr_dna_genes2process=nbr_dna_genes2process, K=K, min_p_value=min_p_value, threshold=threshold, Cs = Cs )
