...
if __name__ == "__main__":
  ...
  deeper_meaning_dna_and_data_correct_by_tissue( data, data.Z, "Z", nbr_dna_genes2process=10, K=5, min_p_value=1, threshold=0.0, Cs = Cs )
  deeper_meaning_dna_and_data_correct_by_tissue( data, data.RNA_fair, "RNA", nbr_dna_genes2process=10, K=5, min_p_value=1, threshold=0.0, Cs = Cs )
