...
if __name__ == "__main__":
  ...
  deeper_meaning_dna_and_rna_fair_correct( data, K=5, min_p_value=1.0, threshold=0.00, Cs = [0.00001,0.0001, 0.001,0.1,1.0,10.0,1000.0] )
  deeper_meaning_dna_and_z_correct( data, K=5, min_p_value=1.0, threshold=0.00, Cs = [0.00001,0.0001, 0.001,0.1,1.0,10.0,1000.0] )
